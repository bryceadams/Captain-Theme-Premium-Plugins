...
class ca_acf_options_page_plugin
{
	var $settings;
	...
	*/
	...
	function __construct()
	{
		...
		// filters
		add_filter('acf/location/rule_types', array($this,'ca_acf_location_rules_types'));
		add_filter('acf/location/rule_values/options_page', array($this,'ca_acf_location_rules_values_options_page'));
	}
	...
	*/
	...
	function ca_acf_location_rules_types( $choices )
	{
	...
	/*
	*  ca_acf_location_rules_values_options_page
	*
	...
	*/
	...
	function ca_acf_location_rules_values_options_page( $choices )
	{
		// default
		$choices = array();
	...
	*/
	...
	{	
		...
		// verify nonce
		if( isset($_POST['ca_acf_nonce']) && wp_verify_nonce($_POST['ca_acf_nonce'], 'input') )
		{
	...
	*/
	...
	function html()
	{
		...
		<div class="wrap no_move">
			...
			<?php $options_name = get_field('change_options_page_name', 'option'); ?>
			<h2><?php if ( $options_name ) { echo $options_name; } else { echo 'Admin Options<sup style="font-size: 12px; padding-left: 5px;">1.4</sup>'; } ?></h2>
			...
			<div class="metabox-holder has-right-sidebar2" id="poststuff">
				...
				<div class="inner-sidebar" id="side-info-column">
					...
					<?php $meta_boxes = do_meta_boxes('ca_acf_options_page', 'side', null); ?>
				...
				<div id="post-body-content">
					...
					<div id="dp-wrapper">
					<?php $meta_boxes = do_meta_boxes('ca_acf_options_page', 'normal', null); ?>

					<div class="clear"></div>

					<div id="dp-footer">
							<input type="hidden" name="HTTP_REFERER" value="<?php echo $_SERVER['HTTP_REFERER'] ?>" />
							<input type="hidden" name="ca_acf_nonce" value="<?php echo wp_create_nonce( 'input' ); ?>" />
					...
					(function($){
						...
						$('#poststuff .postbox[id*="ca_acf_"]').addClass('ca_acf_postbox');
...
$GLOBALS['ca_acf_options_page'] = new ca_acf_options_page_plugin();

/*
*  ca_acf_set_options_page_title
*
...
function ca_acf_set_options_page_title( $title = 'Options' )
{
	$GLOBALS['ca_acf_options_page']->settings['title'] = $title;
}


/*
*  ca_acf_set_options_page_menu
*
...
function ca_acf_set_options_page_menu( $menu = 'Options' )
{
	$GLOBALS['ca_acf_options_page']->settings['menu'] = $menu;
}


/*
*  ca_acf_set_options_page_capability
*
...
function ca_acf_set_options_page_capability( $capability = 'edit_posts' )
{
	$GLOBALS['ca_acf_options_page']->settings['capability'] = $capability;
}


/*
*  ca_acf_add_options_sub_page
*
...
function ca_acf_add_options_sub_page( $page = false )
{
	// validate
	if( !$page )
	{
	...
	$GLOBALS['ca_acf_options_page']->settings['pages'][] = $page;
}
...
*
*  This is an old function which is now referencing the new 'ca_acf_add_options_sub_page' function
*
*  @type	function
*  @since	3.0.0
*  @date	29/01/13
...
if( !function_exists('register_options_page') )
{
	...
	{
		ca_acf_add_options_sub_page( $title );
	}
}
